export function Unternehme() {
  return (
    <div className="body">
      <h1>Unsere Team</h1>
      <p>
        Vertrauen Sie auf das Know-how unseres BPO-Teams. Unsere Expertise liegt
        in der Energiewirtschaft – sie ist sozusagen unsere DNA. Bei der
        ...
        Abrechnungssystemen vertraut und wenden dieses Wissen gezielt an, um für
        Ihre Projekte die besten Praktiken zu nutzen. Die vielfältige
        ...
        zu finden. Unser BPO-Team setzt sich aus Service-Agents, Projektleitern,
        Prozessmanagern, Fachteam-Managern, Produktmanagern und IT-Beratern
        zusammen.
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          <p>
            {" "}
            Der Fachteam-Manager leitet die Teams aus Sachbearbeitern und sorgt
        ...
        <li>
          ...
          <p>
            Der Produktmanager entwickelt unsere BPO-Lösungen ständig weiter, um
